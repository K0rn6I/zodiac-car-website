...
const cars = [
  ...
  { name: "Ferrari 488 Spider", description: "Luxoasă și rapidă, pentru pasionați de viteză.", image: "https://upload.wikimedia.org/wikipedia/commons/c/ce/Ferrari_488_Spider_IMG_2973.jpg" },
  { name: "Mazda MX-5", description: "Visătoare și romantică, perfectă pentru escapade.", image: "https://upload.wikimedia.org/wikipedia/commons/6/66/Mazda_MX-5.jpg" },
  { name: "Mercedes-Benz G-Class", description: "Unic și legendar, cu performanțe pe orice teren.", image: "https://upload.wikimedia.org/wikipedia/commons/5/5b/Mercedes-Benz_G-Class_2018.jpg" },
  { name: "Audi A8", description: "Luxoasă și tehnologic avansată, pentru confortul tău.", image: "https://upload.wikimedia.org/wikipedia/commons/4/47/2019_Audi_A8_3.0T.jpg" },
  { name: "BMW X5", description: "SUV robust și rafinat, perfect pentru orice aventură.", image: "https://upload.wikimedia.org/wikipedia/commons/3/34/2019_BMW_X5_G05_3.0_Front.jpg" },
  { name: "Dodge Viper", description: "Puternică și îndrăzneață, perfectă pentru aventuri!", image: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Dodge_Viper_GTS.jpg" }
];

// Функция для отображения случайной машины
function showCar() {
  const zodiacSelect = document.getElementById("zodiac-select").value;
  const resultContainer = document.getElementById("result");

  // Проверка, выбрана ли зодия
  if (!zodiacSelect) {
